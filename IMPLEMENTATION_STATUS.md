...
| mixed GPU-hit / CPU-miss expert execution | STAGE_B_PASS_OVERLAP_BOUND_IMPLEMENTED_NOT_RUN | Stage B campaign PASS with weighted diagnostic 0.551891 ms / 1.378x vs h=0 and audited extra/repack-aware selector; next gate decomposes h=0..4 and derives a post-D2H CPU/GPU compute-overlap bound with a prospective >=10% weighted-improvement requirement; component campaign NOT_RUN |
