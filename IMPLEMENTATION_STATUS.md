...
| mixed GPU-hit / CPU-miss expert execution | ASYNC_IMPLEMENTED_NOT_AUTHORIZED_PENDING_REVALIDATION | async mechanism is implemented for audit, but the overlap-bound prerequisite and historical residency histogram are withdrawn; new phase-aware histogram replay and corrected overlap-bound campaign are required before physical async execution |
