...
| mixed GPU-hit / CPU-miss expert execution | INCONCLUSIVE_BUILD_PROVENANCE_AND_HISTOGRAM_AUTHORITY | historical h=0..4 measurements are preserved, but the runner did not bind the binary to frozen source/pin and the Stage A histogram authority is withdrawn; weighted 0.551891 ms / 1.378x claim is not admitted |
